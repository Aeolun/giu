...
// GetGLFWBackend returns the underlying glfwbackend.GLFWBackend for platform-specific access.
func (b *GLFWBackend) GetGLFWBackend() *glfwbackend.GLFWBackend {
	return b.GLFWBackend
}
